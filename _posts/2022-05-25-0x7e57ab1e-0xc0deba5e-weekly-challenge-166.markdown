...
I'm glad you asked me that. They were used because **log<sub>x</sub>A + log<sub>x</sub>B = A \* B**, which turns multiplying large numbers into adding smaller numbers, plus looking up the numbers in a [log table](https://en.wikipedia.org/wiki/Mathematical_table#Tables_of_logarithms).
